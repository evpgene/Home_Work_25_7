  ...
  size_t DB_Queries::insertMessage(const int chat_user_id,
  ...
  void DB_Queries::selectMessages_prepare(void) {
  ...
  queue_message_t DB_Queries::selectMessages(const int chat_id,
  ...
  void DB_Queries::selectMessages_close(void) {
    /* Free the prepared result metadata */
  ...
  void DB_Queries::updateStatusDelivered_prepare(void) {
  ...
  size_t DB_Queries::updateStatusDelivered(const int chat_user_id,
                                          const int message_id_begin,
                                          const int message_id_end) {
  ...
  int DB_Queries::updateStatusDelivered_close(void) {
    /* Close the statement */
  ...
  void DB_Queries::updateStatusRead_prepare(void) {
  ...
  size_t DB_Queries::updateStatusRead(const int chat_user_id,
                                      const int message_id_begin,
                                      const int message_id_end) {
  ...
  int DB_Queries::updateStatusRead_close(void) {
    /* Close the statement */
